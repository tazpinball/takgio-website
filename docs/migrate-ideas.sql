...
SELECT
  ...
  CASE
    ...
    WHEN i.metadata->>'stage' = 'Approved' THEN 'Building'
    WHEN i.metadata->>'stage' = 'In Progress' THEN 'Building'
    WHEN i.metadata->>'stage' = 'Testing / Pilot' THEN 'UAT'
    WHEN i.metadata->>'stage' = 'Completed' THEN 'Live'
